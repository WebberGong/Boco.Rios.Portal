 ...
 * $Header: $
 * $Revision: 515322 $
 * $Date: 2007-03-07 06:23:03 +0800 (星期�? 07 三月 2007) $
 * 
...
namespace IBatisNet.DataAccess
{
	...
	public class DaoManager : IDaoManager
	{
		...
		/// </summary>
        public const string DEFAULT_CONTEXT_NAME = "SqlMapDao";
		#endregion
		...
		public static IDaoManager GetInstance(IDao dao) 
		{
            ...
            System.Collections.IDictionaryEnumerator enumerator = _daoImplementationMap.GetEnumerator();
            while (enumerator.MoveNext())
            {
                object k = enumerator.Key;
