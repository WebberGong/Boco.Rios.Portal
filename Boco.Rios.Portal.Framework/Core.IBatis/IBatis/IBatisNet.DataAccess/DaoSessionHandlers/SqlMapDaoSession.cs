 ...
 * $Header: $
 * $Revision: 513043 $
 * $Date: 2007-03-01 06:56:03 +0800 (鏄熸湡鍥? 01 涓夋湀 2007) $
 * 
...
namespace IBatisNet.DataAccess.DaoSessionHandlers
{
	...
	public class SqlMapDaoSession : DaoSession
	{
		...
		public override IDbConnection Connection
		{
			get 
            {
                if (_sqlMap.LocalSession == null) return null;

                return _sqlMap.LocalSession.Connection; 
            }
		}
        ...
        public override int BulkCopyAutoTransaction(string targetTable, DataTable sourceData)
        {
            return _sqlMap.LocalSession.BulkCopyAutoTransaction(targetTable, sourceData);
        }
        ...
        {
            return _sqlMap.LocalSession.BulkCopyLocalTransaction(targetTable, sourceData);
        }
		#endregion
