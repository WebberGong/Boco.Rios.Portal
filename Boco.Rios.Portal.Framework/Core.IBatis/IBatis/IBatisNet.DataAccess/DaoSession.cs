...
namespace IBatisNet.DataAccess
{
	...
	public abstract class DaoSession : IDalSession
	{
        ...
        public abstract int BulkCopyAutoTransaction(string targetTable, DataTable sourceData);
        ...
        /// <returns>返回影响行数</returns>
        public abstract int BulkCopyLocalTransaction(string targetTable, DataTable sourceData);
		#endregion
