...
/*****************************************************************************
 * $Revision: 408099 $
 * $LastChangedDate: 2006-05-21 05:56:36 +0800 (星期�? 21 五月 2006) $
...
namespace IBatisNet.Common
{
    ...
    public class DbProvider : IDbProvider
    {
        ...
        [NonSerialized]
        private string _secondaryAssemblyName = string.Empty;
        [NonSerialized]
        ...
        [NonSerialized]
        private string _bulkCopyClass = string.Empty;
        ...
        [NonSerialized]
        private IDisposable _templateBulkCopy = null;
        [NonSerialized]
        ...
        /// </summary>
        /// <example>Examples : "System.Data", "Microsoft.Data.Odbc"</example>
        [XmlAttribute("secondaryAssemblyName")]
        public string SecondaryAssemblyName
        {
            get { return _secondaryAssemblyName; }
            set
            {
                //CheckPropertyString("SecondaryAssemblyName", value);
                _secondaryAssemblyName = value;
            }
        }
        ...
        /// <summary>
        /// The BulkCopy class name to use.
        /// </summary>
        /// <example >
        /// "IBM.Data.Informix.IfxBulkCopy"
        /// </example>
        [XmlAttribute("bulkCopyClass")]
        public string BulkCopyClass
        {
            get { return this._bulkCopyClass; }
            set
            {
                ///CheckPropertyString("BulkCopyClass", value);
                this._bulkCopyClass = value;
            }
        }
        ...
        /// <summary>
        /// Create an BulkCopy object for this provider
        /// </summary>
        /// <returns></returns>
        public IDisposable CreateBulkCopyObj(IDbConnection conn)
        {
            try
            {
                string bulkCopyClass = _bulkCopyClass;
                bool isSecondAssemblyUsed = bulkCopyClass.StartsWith("SecondaryAssembly:");
                Assembly assembly = isSecondAssemblyUsed ? Assembly.Load(_secondaryAssemblyName) : Assembly.Load(_assemblyName);

                if (isSecondAssemblyUsed)
                    bulkCopyClass = bulkCopyClass.Substring(bulkCopyClass.IndexOf(":") + 1);

                return (IDisposable)assembly.CreateInstance(bulkCopyClass,
                                                            false, BindingFlags.Public | BindingFlags.Instance,
                                                            null,
                                                            new object[] { conn },
                                                            null,
                                                            null);
