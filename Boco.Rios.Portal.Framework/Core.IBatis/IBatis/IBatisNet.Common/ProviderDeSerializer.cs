...
/*****************************************************************************
 * $Revision: 512878 $
 * $LastChangedDate: 2007-03-01 01:57:11 +0800 (星期�? 01 三月 2007) $
...
namespace IBatisNet.Common
{
	...
	public sealed class ProviderDeSerializer
	{
		...
		public static IDbProvider Deserialize(XmlNode node)
		{
            ...
            provider.BulkCopyClass = prop["bulkCopyClass"];
            provider.SecondaryAssemblyName = prop["secondaryAssemblyName"];
