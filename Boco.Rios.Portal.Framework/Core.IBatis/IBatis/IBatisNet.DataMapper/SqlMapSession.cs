 ...
 * $Header: $
 * $Revision: 515691 $
 * $Date: 2007-03-08 02:39:07 +0800 (鏄熸湡鍥? 08 涓夋湀 2007) $
 * 
...
//			}
        ...
        public int BulkCopyAutoTransaction(string targetTable, DataTable sourceData)
        {
            try
            {
                ...
                BeginTransaction();
                rows = this.BulkCopyLocalTransaction(targetTable, sourceData);
                CommitTransaction();
		...
		public void Dispose()
		{
			...
			{
                //if (_connection != null && _connection.State != ConnectionState.Closed) //by davi
                //{
