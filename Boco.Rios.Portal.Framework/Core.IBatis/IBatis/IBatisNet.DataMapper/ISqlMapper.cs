...
namespace IBatisNet.DataMapper
{
    ...
    public interface ISqlMapper
    {
        ...
        /// <returns>DataTable</returns>
        DataTable QueryForDataTable(string statementName, object parameterObject, int skipResults, int maxResults);

        /// <summary>
        /// 执行查询并直接返回IDataReader
        /// </summary>
        /// <param name="statementName">语句名</param>
        /// <param name="parameterObject">参数</param>
        /// <returns>返回包装的SafeDataReader</returns>
        IDataReader ExecuteDataReader(string statementName, object parameterObject);
        ...
        void ExecuteSetConfig(string statementName, object parameterObject);
        #endregion
        ...
        /// <returns></returns>
        int BulkCopyLocalTransaction(string targetTable, DataTable sourceData);
        ...
        int BulkCopyAutoTransaction(string targetTable, DataTable sourceData);
        ...
        /// <summary>
        /// Runs a query for batch list return
        /// </summary>
        ...
        /// <returns></returns>
        IList<T> QueryForList<T>(string statementName, object parameterObject, int batch, ResultListDelegate<T> listDelegate);
#endif
    }
}
