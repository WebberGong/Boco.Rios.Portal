 ...
 * $Header: $
 * $Revision: 587946 $
 * $Date: 2007-10-25 02:12:44 +0800 (鏄熸湡鍥? 25 鍗佹湀 2007) $
 * 
...
namespace IBatisNet.DataMapper.MappedStatements
{
	...
	/// </summary>
    public sealed class CachingStatement : IMappedStatement, ICloneable
	{
		internal MappedStatement _mappedStatement =null;
        ...
        public DataTable ExecuteQueryForDataTable(ISqlMapSession session, object parameterObject)
        {
            ...
            if (dataTable == null)
            {
                dataTable = _mappedStatement.RunQueryForDataTable(request, parameterObject);
            ...
            int skipResults, int maxResults)
        {
            ...
            if (dataTable == null)
            {
                dataTable = _mappedStatement.RunQueryForDataTable(request, parameterObject,skipResults,maxResults);
                this.Statement.CacheModel[cacheKey] = dataTable;
            }
        ...
        public IDataReader ExecuteDataReader(ISqlMapSession session, object parameterObject)
        {
            ...
            return _mappedStatement.ExecuteDataReader(session,parameterObject);
        }
        #endregion
        ...
        {
            return new CachingStatement(this._mappedStatement);
        }
