 ...
 * $Header: $
 * $Revision: 476843 $
 * $Date: 2006-11-20 00:07:45 +0800 (鏄熸湡涓�, 20 鍗佷竴鏈?2006) $
 * 
...
namespace IBatisNet.DataMapper.MappedStatements
{
	...
	public interface IMappedStatement
	{
        ...
        DataTable ExecuteQueryForDataTable(ISqlMapSession session, object parameterObject);
        ...
        /// <returns>A DataTable containing the selected rows.</returns>
        /// <exception cref="IBatisNet.DataMapper.Exceptions.DataMapperException">If a transaction is not in progress, or the database throws an exception.</exception>
        DataTable ExecuteQueryForDataTable(ISqlMapSession session, object parameterObject,int skipResults, int maxResults );
        ...
        IDataReader ExecuteDataReader(ISqlMapSession session, object parameterObject);
        #endregion
        ...
        /// <returns></returns>
        IList<T> ExecuteQueryForList<T>(ISqlMapSession session, object parameterObject, int batch, ResultListDelegate<T> listDelegate);
#endif
        #endregion
